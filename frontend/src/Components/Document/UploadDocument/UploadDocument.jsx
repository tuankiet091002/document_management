                ...
                ></textarea>
                                    ...
                                    isValid.file && file && (<li className="row">
                                            ...
                                            <div className="content">
                                                <div className="details">
                                                    <span
                                                        className="file-name">{`${file.name.length > 12 ? `${file.name.substring(0, 13)}... .${file.name.split('.')[1]}` : file.name} `}</span>
                                                    <span
                                                        className="percent">{progress !== 100 && isValid.file ? `${progress}%` : (
                                                        <i className="fas fa-check"><FaCheck/></i>)}</span>
                                                </div>
                        ...
                        <div className="form-row submit-btn">
                            <div className="input-data">
                                ...
                                <button type="submit"
                                        className={`${progress === 100 && file ? '' : 'disabled'}`}>Submit
                                </button>
                            </div>
                        </div>
                    </form>
